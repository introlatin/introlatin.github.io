...
When you are learning verbs in Latin, you must memorize the way that the verb's entry appears in a dictionary, such as in the [Complete Vocabulary](../../vocabulary/complete-vocabulary) for this very textbook. You'll notice that entries for verbs have five parts: the first four, in Latin, are called **principal parts** and the fifth, in English, is the definition of the verb.
