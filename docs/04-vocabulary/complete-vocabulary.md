...
* cum - (+ abl.) with; (as conjunction + indicative) when, after [(Logeion entry)](https://logeion.uchicago.edu/cum)
...
* quoniam - because [(Logeion entry)](https://logeion.uchicago.edu/quoniam)
